...
class PatientManager:
    ...
    def display_patient_info(self, patient):
        ...
        '''
        print(f'\n{patient.get_pid():<5}{patient.get_name():<16}{patient.get_disease():<15}{patient.get_gender():<14}{patient.get_age()}')
    ...
    def edit_patient_info_by_id(self):
        ...
        for index in range(len(self.patients)):
            ...
            if patient.get_pid() == patient_id:
                ...
                print(f"\nPatient whose ID is {self.patients[index].pid} has been edited.")
                return
    ...
    def write_list_of_patients_to_file(self):
        with open('./Project Data/patients.txt', 'w') as f:
            ...
            for i in range(len(self.patients)):
                ...
                isLast = i == (len(self.patients) - 1)
                lineTerminator = "" if isLast else "\n"
                f.write(patient.__str__() + lineTerminator)
